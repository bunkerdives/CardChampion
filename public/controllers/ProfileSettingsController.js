var ProfileSettingsController = {
    ...
    init : function() {
        ...
        var profileSettingsDataRequest = $.post(
            ...
            , function( data ) {
                ...
                console.log("Successfully grabbed the existing profile settings for this user!");
                
                // prepopulate the profile settings form with the data we received from the server
                ProfileSettingsController.populateProfileSettingsForm( JSON.parse(data) );
    ...
    , sendProfileSettingsRequest : function() {
        ...
        var fullName = $("#profile-settings-full-name").val()
        var location = $("#profile-settings-location").val()
        var description = $("#profile-settings-description").val()
        var thumb = $("#profile-settings-thumbnail").css( 'background-image' )
        var thumbCardName = $("#profile-settings-image-input").val()
